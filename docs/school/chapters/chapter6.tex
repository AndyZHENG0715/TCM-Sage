...
The Arena evaluation provides quantitative evidence: with $p = 0.0018$ and Cohen's $d = 0.47$, the preference for TCM-Sage over the baseline is statistically significant at the 1\% level with a medium effect size. This result held consistently across four days of testing with different tester groups.
